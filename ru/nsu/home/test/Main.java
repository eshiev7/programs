package ru.nsu.home.test;

import ru.nsu.home.Circle;
import ru.nsu.home.Figure;
import ru.nsu.home.Rectangle;
import ru.nsu.home.Square;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i <= kek.length - 1; i++){
            System.out.println("Площадь " + kek[i].getName() + "а: " + kek[i].getArea());
            System.out.println("Координаты " + kek[i].getName() + "а: " + kek[i].getInfo());
        }
    }
}